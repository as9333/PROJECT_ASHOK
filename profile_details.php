                            ...
                            <!-- <div class="col-lg-6"> -->
                                <div class="form-group">
                                    <div align="left" class="form_textbox_styles">
                                    	...
                                    	<center><h5 class="text-wh font-weight-bold" style="color:black; font-size: 40px;"><?php echo $job ?></h5></center>
                                    	<br>
                                        ...
                                        <h5 class="text-wh font-weight-bold" >
                                            <a style="color:black;" href="send_pm_to_profile.php?id=<?php echo $id ?>">Send A Messege To&nbsp<?php echo $name ?> </a>    
                                        </h5>
                                        </center>
