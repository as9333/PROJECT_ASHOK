...
<div class="content">
    ...
    <form action="new_pm.php" method="post">
        ...
        <label for="title"><b>Title</b></label><input type="text" value="<?php echo htmlentities($otitle, ENT_QUOTES, 'UTF-8'); ?>" id="title" name="title" /><br />
        <label for="recip"><b>To</b><span class="small"></span></label>&nbsp&nbsp&nbsp&nbsp<input type="text" value="<?php echo htmlentities($orecip, ENT_QUOTES, 'UTF-8'); ?>" id="recip" name="recip" /><br />
        <label for="message"></label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<textarea placeholder="Message" cols="40" rows="5" id="message" name="message"><?php echo htmlentities($omessage, ENT_QUOTES, 'UTF-8'); ?></textarea><br />
        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="submit" value="Send" name="btn" />
    </form>
</div>
<?php
}
...
?>
	     ...
	     //         echo '<script>window.location="list_pm.php"</script>'; 
	        // }   	
		 ?>  -->
		<div class="foot">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="list_pm.php">Go to my personnal messages</a> 
		</div>
	</body>
</html>